...
public class PiwikLogVisitConverter {
    ...
    public PiwikLogVisitResponse convert(final PiwikLogVisit piwikLogVisit) {
        return new PiwikLogVisitResponse(piwikLogVisit.getIdvisit(), piwikLogVisit.getIdvisitor(), piwikLogVisit.getUser_id(), piwikLogVisit.getVisit_last_action_time(),piwikLogVisit.getLocation_ip());
    }
     ...
     * @return {@link User}
     */
    public PiwikLogVisit convert(final PiwikLogVisitRequest request) {
